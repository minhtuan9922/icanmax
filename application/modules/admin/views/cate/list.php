    ...
    <div class="page-header page-header-default">
        <div class="page-header-content">
            <div class="page-title">
                <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold"><?=$this->lang->line('home'); ?></span> - <?=$this->lang->line('list_cate'); ?></h4>
            </div>

            <div class="heading-elements">
                <div class="heading-btn-group">
                    <a href="<?php echo base_url("admin/cate")?>/add" class="btn btn-link btn-float has-text"><i class="icon-add"></i><span><?=$this->lang->line('add_new'); ?></span></a>
        ...
        <div class="breadcrumb-line">
            <ul class="breadcrumb">
                ...
                <li class="active"><?=$this->lang->line('list_cate'); ?></li>
            </ul>
        </div>
    </div>
    <!-- /page header -->
    ...
    <div class="content">
        ...
        <div class="panel panel-flat">
            <div class="panel-heading">
                <h5 class="panel-title"><?=$this->lang->line('list_cate'); ?></h5>
...
<script type="text/javascript">
    function update_info(id,id_pro,type){
        ...
        $.ajax({
            method:"POST",
            url:"<?=base_url('admin/cate/update_info'); ?>",
