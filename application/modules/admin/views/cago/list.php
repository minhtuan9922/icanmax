    ...
    <div class="page-header page-header-default">
        <div class="page-header-content">
            <div class="page-title">
                <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold"><?=$this->lang->line('home'); ?></span> - <?=$this->lang->line('cago_news'); ?></h4>
            </div>

            <div class="heading-elements">
                <div class="heading-btn-group">
                    <a href="<?php echo base_url("admin/cago")?>/add" class="btn btn-link btn-float has-text"><i class="icon-add"></i><span><?=$this->lang->line('add_new'); ?></span></a>
        ...
        <div class="breadcrumb-line">
            <ul class="breadcrumb">
                ...
                <li class="active"><?=$this->lang->line('cago_news'); ?></li>
            </ul>
        </div>
    </div>
    <!-- /page header -->
    ...
    <div class="content">
        ...
        <div class="panel panel-flat">
            <div class="panel-heading">
                <h5 class="panel-title"><?=$this->lang->line('cago_news'); ?></h5>
                                        ...
                                        <ul class="icons-list">
                                            <li class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a onclick="return check_del()" href="<?php echo base_url("admin/cago/del")."/".$item->cate_id?>"><i class="icon-bin"></i> del</a></li>
                                                    <li><a href="<?php echo base_url("admin/cago/edit")."/".$item->cate_id?>"><i class="icon-pencil7"></i> edit</a></li>
                                                </ul>
                                            </li>
                                        </ul>
                                    </td>
...
<script type="text/javascript">
    function update_info(id,id_pro,type){
        ...
        $.ajax({
            method:"POST",
            url:"<?=base_url('admin/cago/update_info'); ?>",
