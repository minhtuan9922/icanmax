        ...
        <div class="col-md-6">
            ...
            <div class="panel panel-flat">
                ...
                <table class="table datatable-html">
                    ...
                    <tbody>
                        <?php foreach ($position_vn as $key => $item) {?>
                            <tr>
                                <td><?=$item->id?></td>
                                <td><?=$item->name?></td>
                                    ...
                                    <ul class="icons-list">
                                        <li class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <li><a onclick="return editTitle(<?=$item->id?>,1);" data-toggle="modal" data-target="#modal_edit"><i class="icon-pencil7"></i> <?=$this->lang->line('edit'); ?></a></li>
                                            </ul>
                                        </li>
                                    </ul>
                                </td>
        ...
        <div class="col-md-6">
            ...
            <div class="panel panel-flat">
                ...
                <table class="table datatable-html">
                    ...
                    <tbody>
                        <?php foreach ($position_eng as $key => $item) {?>
                            <tr>
                                <td><?=$item->id?></td>
                                <td><?=$item->name?></td>
                                <td class="text-center">
                                    <ul class="icons-list">
                                        <li class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <li><a onclick="return editTitle(<?=$item->id?>,2);" data-toggle="modal" data-target="#modal_edit"><i class="icon-pencil7"></i> <?=$this->lang->line('edit'); ?></a></li>
                                            </ul>
                                        </li>
                                    </ul>
                                </td>
...
<script type="text/javascript">
    function editTitle(id,lang){
        $.ajax({
            dataType: "json",
            type:"POST",
            url:"<?=base_url('/admin/reCate/position_edit'); ?>",
            data:{id:id,lang:lang},
            success: function(result){
                var html        = '<form class="form-horizontal">';
                    html        +=  '<div class="form-group">';
                    html        +=      '<label for="Title" class="col-sm-2 control-label"><?=$this->lang->line('position'); ?></label>';
                    html        +=      '<div class="col-sm-10">';
                    html        +=          '<input type="text" class="form-control" id="Title" placeholder="<?=$this->lang->line('position'); ?>" value="'+result.name+'" required>';
    ...
    function delTitle(id,lang){
        if (confirm("are you ready?")) {
            $.ajax({
                dataType: "json",
                type:"POST",
                url:"<?=base_url('admin/reCate/position_del'); ?>",
                data:{id:id,lang:lang},
                success: function(result){
                    if(result == 1){
    ...
    function saveTitle(){
        ...
        $.ajax({
            dataType: "json",
            type:"POST",
            url:"<?=base_url('/admin/reCate/position_update'); ?>",
            ...
            <div class="modal-body">
                <form class="form-horizontal">
                    <div class="form-group">
                        <label for="Title" class="col-sm-2 control-label"><?=$this->lang->line('position'); ?></label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="Title" placeholder="<?=$this->lang->line('position'); ?>" />
                        </div>
                    </div>
                    <div class="form-group">
...
<script type="text/javascript">
    function addDataTitle(){
        ...
        $.ajax({
            dataType: "json",
            type:"POST",
            url:"<?=base_url('admin/reCate/position_add'); ?>",
