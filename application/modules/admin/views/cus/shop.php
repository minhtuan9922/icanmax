    ...
    <div class="page-header page-header-default">
        <div class="page-header-content">
            <div class="page-title">
                <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">admin</span> - List admin</h4>
            </div>

            <div class="heading-elements">
                <div class="heading-btn-group">
                    <a href="<?php echo base_url("admin/admin")?>/add" class="btn btn-link btn-float has-text"><i class="icon-add"></i><span>Add</span></a>
    ...
    <div class="content">
        ...
        <div class="panel panel-flat">
            <div class="panel-heading">
                <h5 class="panel-title">admin data</h5>
                            ...
                            <ul class="icons-list">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right">
                                        <li><a onclick="return check_del()" href="<?=site_url()?>/admin/admin/del/<?=$item->user_id?>.html"><i class="icon-bin"></i> del</a></li>
                                        <li><a href="<?=base_url()?>admin/admin/edit/<?=$item->user_id?>"><i class="icon-pencil7"></i> edit</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </td>
