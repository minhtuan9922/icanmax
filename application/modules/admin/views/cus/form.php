                    ...
                    <fieldset class="content-group">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" name="user_name" value="<?=set_value('user_name')?set_value('user_name'):$admin->user_name;?>">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" name="user_fullname" value="<?=set_value('user_fullname')?set_value('user_fullname'):$admin->user_fullname;?>">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <input type="checkbox" name="user_status" value="1" <?php echo $admin->user_status==1?'checked':'ád'; ?> > Active
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <input type="password" class="form-control" name="user_password" value="<?=set_value('user_password');?>">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" name="user_phone" value="<?=set_value('user_phone')?set_value('user_phone'):$admin->user_phone;?>">
                                </div>
