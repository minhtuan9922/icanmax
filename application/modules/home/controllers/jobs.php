...
class Jobs extends MY_Controller {
	...
	public function index()
	{
		// career search
	 	...
	 	//view and const	
	 	$this->data['profile_details']		= 'user-managerfile/view-profile'; // link tag a
		$this->data['title']        		= 'Người tìm việc';
		$this->data['key']        			= '';
		$this->data['des']     	 			= '';
		$this->data['active_job']			= true;
		$this->data['content']      		= 'seeker_job/content';
