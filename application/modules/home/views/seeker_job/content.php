                    ...
                    <table id="hprofile" class="table table-hover" >
                        <thead>
                            <tr style="color: #387dd2;font-size: 13px;">
                                <th style="text-align: left;">TUYỂN DỤNG</th>
                                <th>KHU VỰC</th>
                                <th>MỨC LƯƠNG</th>
                                <th>NGÀY HẾT HẠN</th>
                                <th>CẬP NHẬT</th>
                            ...
                            ?>
                                <tr name="profile">
                                    <td style="text-align: left;" >
                                        <div>
                                            <a style="color:black;" href="<?php echo base_url($profile_details).'/'.$value_profile["profile_id"].'/'.$this->my_string->remove_vn_unicode(str_replace(" ","-",$value_profile["fullname"])); ?>">
                                                <b>
                                                    <?php echo $value_profile['profile_title']; ?> 
                                                </b>
                                            </a>
                                        </div>
                                        <span><?php echo $value_profile['fullname']; ?></span></td>
                                    <td> 
                                        <div>
                                            <?php 
