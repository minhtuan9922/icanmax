...
*
* ---------------------------------------------------------------------------- */
var base_url = "http://localhost:8284//";
var site_url = base_url+'assets/demo_data/';
$(function() {
    ...
    $('.datatable-ajax').dataTable({
        ajax: site_url+'/tables/datatable_ajax.json'
    });
    ...
    $('.datatable-nested').dataTable({
        ajax: site_url+'/tables/datatable_nested.json',
        columns: [
            {data: "name[, ]"},
            {data: "hr.0" },
            {data: "office"},
