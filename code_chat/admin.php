...
if(!$user->_is_admin) {
    _error(__('Thông báo hệ thống'), "<p class='text-center'>".__("Bạn không có quyền để truy cập trang này")."</p>");
}
...
switch ($_GET['view']) {
	...
	case 'settings':
		// page header
		page_header(__("Admin")." &rsaquo; ".__("Thiết lập"));
		break;
	...
	case 'users':
		...
		switch ($_GET['sub_view']) {
			case '':
				// page header
				page_header(__("Admin")." &rsaquo; ".__("Người dùng"));
			...
			case 'admins':
				// page header
				page_header(__("Admin")." &rsaquo; ".__("Người dùng")." &rsaquo; ".__("Quản trị viên"));
			...
			case 'moderators':
				// page header
				page_header(__("Admin")." &rsaquo; ".__("Người dùng")." &rsaquo; ".__("Người điều hành"));
			...
			case 'online':
				// page header
				page_header(__("Admin")." &rsaquo; ".__("Người dùng")." &rsaquo; ".__("Trực tuyến"));
			...
			case 'banned':
				// page header
				page_header(__("Admin")." &rsaquo; ".__("Người dùng")." &rsaquo; ".__("Khóa"));
			...
			case 'edit':
				...
				// page header
				page_header(__("Admin")." &rsaquo; ".__("Người dùng")." &rsaquo; ".$data['user_fullname']);
				break;
	...
	case 'pages':
		...
		switch ($_GET['sub_view']) {
			...
			case 'edit':
				...
				// page header
				page_header(__("Admin")." &rsaquo; ".__("Trang")." &rsaquo; ".$data['page_title']);
				break;
	...
	case 'categories':
		...
		switch ($_GET['sub_view']) {
			case '':
				// page header
				page_header(__("Admin")." &rsaquo; ".__("Danh mục"));
			...
			case 'edit':
				...
				// page header
				page_header(__("Admin")." &rsaquo; ".__("Danh mục")." &rsaquo; ".$data['category_name']);
				break;

			case 'add':
				// page header
				page_header(__("Admin")." &rsaquo; ".__("Danh mục")." &rsaquo; ".__("Thêm mới"));
				break;
	...
	case 'groups':
		...
		switch ($_GET['sub_view']) {
			case '':
				// page header
				page_header(__("Admin")." &rsaquo; ".__("Nhóm"));
			...
			case 'edit':
				...
				// page header
				page_header(__("Admin")." &rsaquo; ".__("Nhóm")." &rsaquo; ".$data['group_title']);
				break;
	...
	case 'verified':
		...
		switch ($_GET['sub_view']) {
			case 'users':
				// page header
				page_header(__("Admin")." &rsaquo; ".__("xác thực")." &rsaquo; ".__("Người dùng"));
			...
			case 'pages':
				// page header
				page_header(__("Admin")." &rsaquo; ".__("Xác thực")." &rsaquo; ".__("Trang"));
	...
	case 'reports':
		// page header
		page_header(__("Admin")." &rsaquo; ".__("Báo cáo"));
	...
	case 'static':
		...
		switch ($_GET['sub_view']) {
			case '':
				// page header
				page_header(__("Admin")." &rsaquo; ".__("Trang tĩnh"));
			...
			case 'edit':
				...
				// page header
				page_header(__("Admin")." &rsaquo; ".__("Trang tĩnh")." &rsaquo; ".$data['page_title']);
				break;

			case 'add':
				// page header
				page_header(__("Admin")." &rsaquo; ".__("Trang tĩnh")." &rsaquo; ".__("Thêm mới"));
				break;
	...
	case 'ads':
		...
		switch ($_GET['sub_view']) {
			case '':
				// page header
				page_header(__("Admin")." &rsaquo; ".__("Quảng cáo"));
			...
			case 'add':
				// page header
				page_header(__("Admin")." &rsaquo; ".__("Quảng cáo")." &rsaquo; ".__("Thêm mới"));
				break;
	...
	case 'languages':
		...
		switch ($_GET['sub_view']) {
			...
			case 'edit':
				...
				// page header
				page_header(__("Admin")." &rsaquo; ".__("Ngôn ngữ")." &rsaquo; ".$data['title']);
				break;

			case 'add':
				// page header
				page_header(__("Admin")." &rsaquo; ".__("Ngôn ngữ")." &rsaquo; ".__("Thêm mới"));
				break;
	...
	case 'themes':
		...
		switch ($_GET['sub_view']) {
			case '':
				// page header
				page_header(__("Admin")." &rsaquo; ".__("Giao diện"));
			...
			case 'edit':
				...
				// page header
				page_header(__("Admin")." &rsaquo; ".__("Giao diện")." &rsaquo; ".$data['name']);
				break;

			case 'add':
				// page header
				page_header(__("Admin")." &rsaquo; ".__("Giao diện")." &rsaquo; ".__("Thêm mới"));
				break;
	...
	case 'widgets':
		...
		switch ($_GET['sub_view']) {
			case '':
				// page header
				page_header(__("Admin")." &rsaquo; ".__("Chức năng"));
			...
			case 'edit':
				...
				// page header
				page_header(__("Admin")." &rsaquo; ".__("Chức năng")." &rsaquo; ".$data['title']);
				break;

			case 'add':
				// page header
				page_header(__("Admin")." &rsaquo; ".__("Chức năng")." &rsaquo; ".__("Thêm mới"));
				break;
	...
	case 'games':
		...
		switch ($_GET['sub_view']) {
			case '':
				// page header
				page_header(__("Admin")." &rsaquo; ".__("Trò chơi"));
			...
			case 'edit':
				...
				// page header
				page_header(__("Admin")." &rsaquo; ".__("Trò chơi")." &rsaquo; ".$data['title']);
				break;

			case 'add':
				// page header
				page_header(__("Admin")." &rsaquo; ".__("Trò chơi")." &rsaquo; ".__("Thêm mới"));
				break;
