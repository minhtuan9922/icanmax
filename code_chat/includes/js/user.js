...
$(function() {
    ...
    $('body').on('submit', '.x-uploader', function(e) {
        ...
        if(handle !== undefined) {
            ...
            if(id !== undefined) {
                options['data'] = {'handle': handle, 'id': id}
            } else {
            ...
            if(handle == "cover-user" || handle == "cover-page" || handle == "cover-group") {
                ...
                /* check if there is already scrabing process */
                if(publisher.data('scrabing')) {
                    return false;
                }
            ...
            if(response.callback) {
                ...
                if(handle !== undefined) {
                    if(handle == "cover-user" || handle == "cover-page" || handle == "cover-group") {
                        ...
                        var image_path = uploads_path+'/'+response.file;
                        attachments.find('ul').append(render_template("#publisher-attachments-item", {'src':response.file, 'image_path':image_path}));
