...
// valid inputs
$valid['edit'] = array('username', 'email', 'password', 'basic', 'work', 'location', 'education', 'privacy');
...
try {
	...
	if($_GET['edit'] == "username") {
		...
		$user->settings($args);
		return_json( array('success' => true, 'message' => __("Hoàn tất, tên đăng nhập của bạn đã được cập nhật")) );
		...
		$user->settings($args);
		return_json( array('success' => true, 'message' => __("Hoàn tất, Email đã được cập nhật")) );
		...
		$user->settings($args);
		return_json( array('success' => true, 'message' => __("Hoàn tất, mật khẩu đã được cập nhật")) );
		...
		$user->settings($args);
		return_json( array('success' => true, 'message' => __("Hoàn tất, thông tin tiểu sử của bạn đã được cập nhật")) );
		...
		$user->settings($args);
		return_json( array('success' => true, 'message' => __("Hoàn tất, cài đặt bảo mật của bạn đã được cập nhật")) );
