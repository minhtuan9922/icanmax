    ...
    <div class="data-container {if $_small}small{/if}">
        ...
        <div class="data-content">
            <div class="pull-right flip">
                ...
                <div class="btn btn-primary js_friend-accept" data-uid="{$_user['user_id']}">{__("Chấp nhận")}</div>
                <div class="btn btn-default js_friend-decline" data-uid="{$_user['user_id']}">{__("Từ chối")}</div>
                ...
                <div class="btn btn-danger js_unblock-user" data-uid="{$_user['user_id']}">
                    <i class="fa fa-trash fa-fw"></i> {__("Bỏ chặn")}
                </div>
                {/if}
            </div>
            <div>
            ...
            <div>
                <span class="text-underline" data-toggle="modal" data-url="users/mutual_friends.php?uid={$_user['user_id']}">{$_user['mutual_friends_count']} {__("bạn chung")}</span>
            </div>
            {/if}
        </div>
    </div>
