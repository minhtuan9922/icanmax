...
<div class="container">
    <div class="row">
        <div class="col-md-4 col-md-offset-4">
            <h3 class="mb20 text-center">{__("Đăng nhập")}</h3>
            ...
            <form class="js_ajax-forms" data-url="core/signin.php">
                <div class="form-group">
                    <label for="username_email">{__("Email")} {__("hoặc")} {__("Tên đăng nhập")}</label>
                ...
                <div class="checkbox clearfix">
                    <label>
                        <input name="remember" type="checkbox"> {__("Lưu đăng nhập")}
                    </label>
                </div>
                <button name="submit" type="submit" class="btn btn-lg btn-primary btn-block">{__("Đăng nhập")}</button>
