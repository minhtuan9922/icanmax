    				...
    				<div class="post-header">
    					...
    					<div class="post-meta">
    						...
    						<div class="post-time">
    							...
    							<i class="fa fa-users" data-toggle="tooltip" data-placement="top" title="{__("Shared with")}: {__("Bạn bè")}"></i>
    							{else}
    							<i class="fa fa-globe" data-toggle="tooltip" data-placement="top" title="{__("Shared with")}: {__("Bạn bè")}"></i>
    							{/if}
    						</div>
    						<!-- post time & location & privacy -->
    					</div>
